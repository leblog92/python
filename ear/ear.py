...
# def ajouter_commande_personnalisee(app):
    # """Permet d'ajouter une commande personnalisée via l'interface"""
    # print("\n=== Ajouter une nouvelle commande ===")
    
    # nom = input("Nom de la commande (ex: 'fichier excel'): ").lower().strip()
    # type_cmd = input("Type (fichier/programme): ").lower().strip()
    
    # if type_cmd == "fichier":
        # chemin = input("Chemin complet du fichier: ").strip()
        # app.ajouter_commande_systeme(nom, chemin_fichier=chemin)
    # elif type_cmd == "programme":
        # programme_windows = input("Commande Windows: ").strip()
        # programme_linux = input("Commande Linux (appuyez sur Entrée pour passer): ").strip()
        # programme_mac = input("Commande macOS (appuyez sur Entrée pour passer): ").strip()
        
        # programme_dict = {
            # "windows": programme_windows
        # }
        # if programme_linux:
            # programme_dict["linux"] = programme_linux
        # if programme_mac:
            # programme_dict["mac"] = programme_mac
            
        # app.ajouter_commande_systeme(nom, programme=programme_dict)
    # else:
